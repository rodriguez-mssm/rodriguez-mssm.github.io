...
export async function mountStemcellRegistration({ container, source, api, typeOptions, escapeHtml, toast, locationInput }) {
    ...
    form.onsubmit = async (event) => {
      ...
      try {
        ...
        const payload = {
          ...
          sample_location: locationInput.value.trim() || null,
